    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="teacher_login.php" class="active" style="color: #ff4925;" onmouseover="this.style.color='#ff4925'" onmouseout="this.style.color='#ff4925'">Login</a>
          </li>
        </ul>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="role-selection">
          <div class="btn-group" role="group" aria-label="Role Selection">
            <button type="button" class="btn btn-outline-primary" id="select-teacher" style="border-color: #ff4925;; fill: #ff4925;;" onclick="window.location.href='teacher_login.php'">Teacher</button>
        ...
        <div class="form-container">
          <form action="login_student.php" method="post" class="row g-3">
